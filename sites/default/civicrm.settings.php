...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/tpgd_drupal?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:root@localhost/tpgd_civicrm?new_link=true' );
}
...
$civicrm_root = '/Users/Jamie/www/tpg-crm/httpdocs/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Users/Jamie/www/tpg-crm/httpdocs/sites/default/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://tpg-crm.local/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '6622f52f9f8462c52ba06419f303156a' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/Users/Jamie/www/tpg-crm/httpdocs/sites/default/files/civicrm/templates_c//mail.log' );
// }
